...
const[companyFinYear, setCompanyFinYear] = useState('')
    ...
    const [companySearch, setCompnySearch] = useState('');
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="submit" className="btn btn-success" data-dismiss="modal" onClick={(e) => saveComapnyDetails(e)}> Submit</button>
